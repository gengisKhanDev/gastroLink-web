...
Meteor.methods({
  "create.business"(id, businessName, businessAddress, phoneNumber, businessEmail, maxCapacity, description) {
    if (!Meteor.userId()) {
  ...
  "update.businessInfo"(id, businessName, businessAddress, phoneNumber, businessEmail, maxCapacity, description) {
    if (!Meteor.userId()) {
      throw new Meteor.Error("not-authorized");
    }
